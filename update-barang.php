...
<body class="skin-black">
    ...
    <header class="header">
        ...
        <div class="content">
            ...
            <center><h4 for="user">Update Barang</h4></center>
                <div class="row">
                    <div class="col-md-3">
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="jumlah" placeholder="Jumlah" value="<?php echo $row['jumlah_barang'];?>">
                                </div>  
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="user">SATUAN</label>
                                    <input type="text" class="form-control" name="satuan" placeholder="Satuan Barang" value="<?php echo $row['satuan'];?>">
                                </div>
                            </div>    
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="spesifikasi" placeholder="Spesifikasi Barang" value="<?php echo $row['spesifikasi'];?>">
                                </div>        
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="harga_beli" placeholder="Harga Beli" value="<?php echo $row['harga_beli'];?>">
                                </div>
                            </div> 
                             <div class="col-md-6">
                                <div class="form-group">
