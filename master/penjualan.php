        ...
        <div class="overlay">            
            <div class="container">
              	    <div class="col-lg-11 col-md-11 col-sm-11 text-center">
                        ...
                        <a href="penjualan-kasir.php" class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".3s">
                            <i class="fa fa-briefcase icon-round"></i>
                            <h3 class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".4s">Tabel Penjualan</h3>
                        </a>
                        <a href="tabel-transaksi-penjualan.php" class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".5s">
                            <i class="fa fa-briefcase icon-round icon-round-active"></i>
                            <h3 class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".6s">Tabel Transaksi Penjualan </h3>
                        </a>
                    </div>
            </div>
            </div>
