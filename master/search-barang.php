            ...
            <div class="container-fluid">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <input type="hidden" name="">
                        ...
                        $no=1;
                        $kunci=$_POST['kunci'];
                        $result=mysqli_query($link, "SELECT * FROM barang WHERE id_barang LIKE '%$kunci%' or nama_barang LIKE '%$kunci%' or kategori LIKE '%$kunci%' ");
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="update-barang.php?id=<?php echo $row['id_barang'];?>" class="btn btn-info"><span class="glyphicon glyphicon-pencil"></span>
                                </a>
