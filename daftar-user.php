                	...
                	<div class="card">
                        ...
                        <form method="POST" action="">
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="update-user.php?id=<?php echo $row['id_user'];?>" class="btn btn-info">UPDATE</a>
                                <a href="proses-deleteuser.php?id=<?php echo $row['id_user'];?>" class="btn btn-info">DELETE</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </form>
